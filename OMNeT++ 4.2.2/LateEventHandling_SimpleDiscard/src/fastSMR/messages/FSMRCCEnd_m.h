...
#ifndef _FSMRCCEND_M_H_
#define _FSMRCCEND_M_H_
...
/**
 * Class generated from <tt>fastSMR/messages/FSMRCCEnd.msg</tt> by opp_msgc.
 * <pre>
 * packet FSMRCCEnd {
 ...
 * </pre>
 */
class FSMRCCEnd : public ::cPacket
{
  protected:
  ...
  private:
    void copy(const FSMRCCEnd& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const FSMRCCEnd&);

  public:
    FSMRCCEnd(const char *name=NULL, int kind=0);
    FSMRCCEnd(const FSMRCCEnd& other);
    virtual ~FSMRCCEnd();
    FSMRCCEnd& operator=(const FSMRCCEnd& other);
    virtual FSMRCCEnd *dup() const {return new FSMRCCEnd(*this);}
...
inline void doPacking(cCommBuffer *b, FSMRCCEnd& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, FSMRCCEnd& obj) {obj.parsimUnpack(b);}


#endif // _FSMRCCEND_M_H_
