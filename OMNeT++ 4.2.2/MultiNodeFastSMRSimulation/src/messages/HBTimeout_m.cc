...
void HBTimeout::copy(const HBTimeout& other)
{
    ...
    this->hostAddr_var = other.hostAddr_var;
}
...
void HBTimeout::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->hostAddr_var);
}
...
const char * HBTimeout::getHostAddr() const
{
    return hostAddr_var.c_str();
}

void HBTimeout::setHostAddr(const char * hostAddr)
{
    this->hostAddr_var = hostAddr;
}
...
int HBTimeoutDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='h' && strcmp(fieldName, "hostAddr")==0) return base+2;
...
std::string HBTimeoutDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return oppstring2string(pp->getHostAddr());
        default: return "";
    }
}
...
bool HBTimeoutDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setHostAddr((value)); return true;
