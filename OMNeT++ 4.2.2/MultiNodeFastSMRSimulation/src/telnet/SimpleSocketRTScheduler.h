 ...
 */
class SimpleSocketRTScheduler : public cScheduler
{
  protected:
    // config
    int port;
  ...
  public:
     ...
     * Constructor.
     */
    SimpleSocketRTScheduler();

    /**
     * Destructor.
     */
    virtual ~SimpleSocketRTScheduler();
    ...
    /**
     * check whether the setInterfaceModule has been called in the simulation
     */
