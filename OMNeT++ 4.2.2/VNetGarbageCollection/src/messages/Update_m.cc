//
// Generated file, do not edit! Created by opp_msgc 4.2 from messages/Update.msg.
//
...
int UpdateDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='s' && strcmp(fieldName, "sourceName")==0) return base+5;
    if (fieldName[0]=='d' && strcmp(fieldName, "destName")==0) return base+6;
...
std::string UpdateDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 5: return oppstring2string(pp->getSourceName());
        case 6: return oppstring2string(pp->getDestName());
        default: return "";
    }
}
...
bool UpdateDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 5: pp->setSourceName((value)); return true;
        case 6: pp->setDestName((value)); return true;
