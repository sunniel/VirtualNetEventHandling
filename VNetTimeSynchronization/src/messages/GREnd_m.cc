//
// Generated file, do not edit! Created by opp_msgc 4.2 from messages/GREnd.msg.
//
...
const char * GREnd::getQd() const
{
    return Qd_var.c_str();
}

void GREnd::setQd(const char * Qd)
{
    this->Qd_var = Qd;
}

const char * GREnd::getQp() const
{
    return Qp_var.c_str();
}

void GREnd::setQp(const char * Qp)
{
    this->Qp_var = Qp;
}

const char * GREnd::getSenders() const
{
    return senders_var.c_str();
}

void GREnd::setSenders(const char * senders)
{
    this->senders_var = senders;
}

const char * GREnd::getSors() const
{
    return sors_var.c_str();
}

void GREnd::setSors(const char * sors)
{
    this->sors_var = sors;
}
