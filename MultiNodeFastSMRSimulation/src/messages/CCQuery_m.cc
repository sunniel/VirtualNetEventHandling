//
// Generated file, do not edit! Created by opp_msgc 4.2 from messages/CCQuery.msg.
//
...
void CCQuery::copy(const CCQuery& other)
{
    ...
    this->candidate_var = other.candidate_var;
}
...
void CCQuery::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->candidate_var);
}
...
void CCQuery::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->candidate_var);
}
...
const char * CCQuery::getCandidate() const
{
    return candidate_var.c_str();
}

void CCQuery::setCandidate(const char * candidate)
{
    this->candidate_var = candidate;
}
...
int CCQueryDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "candidate")==0) return base+1;
...
std::string CCQueryDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return oppstring2string(pp->getCandidate());
        default: return "";
    }
}
...
bool CCQueryDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setCandidate((value)); return true;
