//
// Generated file, do not edit! Created by opp_msgc 4.2 from basicSMR/messages/CCQueryReply.msg.
//
...
const char * CCQueryReply::getState() const
{
    return state_var.c_str();
}

void CCQueryReply::setState(const char * state)
{
