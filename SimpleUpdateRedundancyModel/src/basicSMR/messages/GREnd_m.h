...
/**
 * Class generated from <tt>basicSMR/messages/GREnd.msg</tt> by opp_msgc.
 * <pre>
 * packet GREnd {
...
class GREnd : public ::cPacket
{
  ...
  public:
    GREnd(const char *name=NULL, int kind=0);
    GREnd(const GREnd& other);
    virtual ~GREnd();
    GREnd& operator=(const GREnd& other);
    virtual GREnd *dup() const {return new GREnd(*this);}
...
inline void doPacking(cCommBuffer *b, GREnd& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, GREnd& obj) {obj.parsimUnpack(b);}
