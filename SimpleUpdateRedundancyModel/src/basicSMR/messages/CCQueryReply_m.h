...
#ifndef _CCQUERYREPLY_M_H_
#define _CCQUERYREPLY_M_H_
...
/**
 * Class generated from <tt>basicSMR/messages/CCQueryReply.msg</tt> by opp_msgc.
 * <pre>
 * packet CCQueryReply {
 ...
 * </pre>
 */
class CCQueryReply : public ::cPacket
{
  protected:
  ...
  public:
    CCQueryReply(const char *name=NULL, int kind=0);
    CCQueryReply(const CCQueryReply& other);
    virtual ~CCQueryReply();
    CCQueryReply& operator=(const CCQueryReply& other);
    virtual CCQueryReply *dup() const {return new CCQueryReply(*this);}
...
inline void doPacking(cCommBuffer *b, CCQueryReply& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, CCQueryReply& obj) {obj.parsimUnpack(b);}


#endif // _CCQUERYREPLY_M_H_
