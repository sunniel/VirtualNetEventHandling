...
#ifndef BASICSMRNODE_H_
#define BASICSMRNODE_H_
...
class BasicSMRNode: public GatebasedModule {
private:
...
protected:
    ...
    virtual void collectAgreement(BSMRAgree* agreement);
    virtual void checkAgreements();
    virtual void handleFinal(BSMRFinal* final);
