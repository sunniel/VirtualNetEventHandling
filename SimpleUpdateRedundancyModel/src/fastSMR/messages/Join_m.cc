//
// Generated file, do not edit! Created by opp_msgc 4.2 from fastSMR/messages/Join.msg.
//
...
int JoinDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='c' && strcmp(fieldName, "cycleLength")==0) return base+2;
...
std::string JoinDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return double2string(pp->getCycleLength());
        default: return "";
    }
}
...
bool JoinDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setCycleLength(string2double(value)); return true;
