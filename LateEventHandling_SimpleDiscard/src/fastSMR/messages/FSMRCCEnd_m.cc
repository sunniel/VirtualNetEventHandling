//
// Generated file, do not edit! Created by opp_msgc 4.2 from fastSMR/messages/FSMRCCEnd.msg.
//
...
Register_Class(FSMRCCEnd);

FSMRCCEnd::FSMRCCEnd(const char *name, int kind) : cPacket(name,kind)
{
...
FSMRCCEnd::FSMRCCEnd(const FSMRCCEnd& other) : cPacket(other)
{
    copy(other);
}
...
FSMRCCEnd& FSMRCCEnd::operator=(const FSMRCCEnd& other)
{
...
void FSMRCCEnd::copy(const FSMRCCEnd& other)
{
...
void FSMRCCEnd::parsimPack(cCommBuffer *b)
{
...
void FSMRCCEnd::parsimUnpack(cCommBuffer *b)
{
...
const char * FSMRCCEnd::getDisplayString() const
{
    return displayString_var.c_str();
}

void FSMRCCEnd::setDisplayString(const char * displayString)
{
    this->displayString_var = displayString;
}

const char * FSMRCCEnd::getSenderName() const
{
    return senderName_var.c_str();
}

void FSMRCCEnd::setSenderName(const char * senderName)
{
    this->senderName_var = senderName;
}

int FSMRCCEnd::getEpoch() const
{
    return epoch_var;
}

void FSMRCCEnd::setEpoch(int epoch)
{
    this->epoch_var = epoch;
}

int FSMRCCEnd::getGroupId() const
{
    return groupId_var;
}

void FSMRCCEnd::setGroupId(int groupId)
{
    this->groupId_var = groupId;
}

const char * FSMRCCEnd::getGroupMembers() const
{
    return groupMembers_var.c_str();
}

void FSMRCCEnd::setGroupMembers(const char * groupMembers)
{
    this->groupMembers_var = groupMembers;
}

const char * FSMRCCEnd::getQd() const
{
    return Qd_var.c_str();
}

void FSMRCCEnd::setQd(const char * Qd)
{
    this->Qd_var = Qd;
}

const char * FSMRCCEnd::getQp() const
{
    return Qp_var.c_str();
}

void FSMRCCEnd::setQp(const char * Qp)
{
    this->Qp_var = Qp;
}

const char * FSMRCCEnd::getSenders() const
{
    return senders_var.c_str();
}

void FSMRCCEnd::setSenders(const char * senders)
{
    this->senders_var = senders;
}

const char * FSMRCCEnd::getSors() const
{
    return sors_var.c_str();
}

void FSMRCCEnd::setSors(const char * sors)
{
    this->sors_var = sors;
}

int FSMRCCEnd::getEscId() const
{
    return escId_var;
}

void FSMRCCEnd::setEscId(int escId)
{
    this->escId_var = escId;
}

long FSMRCCEnd::getEsc() const
{
    return esc_var;
}

void FSMRCCEnd::setEsc(long esc)
{
    this->esc_var = esc;
}

class FSMRCCEndDescriptor : public cClassDescriptor
{
  public:
    FSMRCCEndDescriptor();
    virtual ~FSMRCCEndDescriptor();
...
Register_ClassDescriptor(FSMRCCEndDescriptor);

FSMRCCEndDescriptor::FSMRCCEndDescriptor() : cClassDescriptor("FSMRCCEnd", "cPacket")
{
}

FSMRCCEndDescriptor::~FSMRCCEndDescriptor()
{
}

bool FSMRCCEndDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<FSMRCCEnd *>(obj)!=NULL;
}

const char *FSMRCCEndDescriptor::getProperty(const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
}

int FSMRCCEndDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 11+basedesc->getFieldCount(object) : 11;
}

unsigned int FSMRCCEndDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *FSMRCCEndDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int FSMRCCEndDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *FSMRCCEndDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *FSMRCCEndDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int FSMRCCEndDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    FSMRCCEnd *pp = (FSMRCCEnd *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string FSMRCCEndDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool FSMRCCEndDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *FSMRCCEndDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *FSMRCCEndDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
