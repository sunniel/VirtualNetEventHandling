...
#include "ConsensusBasedClient.h"

Define_Module(ConsensusBasedClient);

ConsensusBasedClient::ConsensusBasedClient() {
...
void ConsensusBasedClient::disposeTimeouts() {
    try {
...
int ConsensusBasedClient::numInitStages() const {
    return STAGE_NUM;
}

void ConsensusBasedClient::initialize(int stage) {
    if (stage == 0) {
        HostBase::initialize();
...
void ConsensusBasedClient::dispatchHandler(cMessage *msg) {
...
void ConsensusBasedClient::handleNeighborDiscovery(cMessage* msg) {
...
void ConsensusBasedClient::handleJoin(cMessage* msg) {
...
void ConsensusBasedClient::handleCycleEvent(cMessage* msg) {
...
void ConsensusBasedClient::handleUpdate(cMessage* msg) {
...
void ConsensusBasedClient::handleConfigUpdate(cMessage* msg) {
...
void ConsensusBasedClient::handleLoad() {
...
void ConsensusBasedClient::handleConnectReply(cMessage* msg) {
...
void ConsensusBasedClient::handleConnectTimeout(cMessage* msg) {
...
void ConsensusBasedClient::finish() {
