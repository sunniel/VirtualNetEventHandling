...
#ifndef __CONSENSUS_BASED_NODEAPP_H_
#define __CONSENSUS_BASED_NODEAPP_H_
...
protected:
    ...
    virtual void applyEvent(ConsensusBasedEventApply* event);
public:
    ConsensusBasedApp();
    virtual ~ConsensusBasedApp();
