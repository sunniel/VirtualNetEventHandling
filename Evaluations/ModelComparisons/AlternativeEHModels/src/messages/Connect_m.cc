...
Connect::Connect(const char *name, short kind) : ::omnetpp::cPacket(name,kind)
{
}

Connect::Connect(const Connect& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
const char * Connect::getLCName() const
{
    return this->LCName.c_str();
}

void Connect::setLCName(const char * LCName)
{
    this->LCName = LCName;
}
...
ConnectDescriptor::ConnectDescriptor() : omnetpp::cClassDescriptor("Connect", "omnetpp::cPacket")
{
...
int ConnectDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='L' && strcmp(fieldName, "LCName")==0) return base+0;
...
std::string ConnectDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Connect *pp = (Connect *)object; (void)pp;
    switch (field) {
        case 0: return oppstring2string(pp->getLCName());
        default: return "";
    }
}
...
bool ConnectDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Connect *pp = (Connect *)object; (void)pp;
    switch (field) {
        case 0: pp->setLCName((value)); return true;
