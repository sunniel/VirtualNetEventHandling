...
#ifndef __PRIMARY_BACKUP_CLIENT_H_
#define __PRIMARY_BACKUP_CLIENT_H_
...
class PrimaryBackupClient: public HostBase {
private:
    unsigned long id;
...
public:
    PrimaryBackupClient();
    virtual ~PrimaryBackupClient();
    IPvXAddress getRendezvous() {
        return rendezvous;
    }
};

#endif /* __PRIMARY_BACKUP_CLIENT_H_ */
