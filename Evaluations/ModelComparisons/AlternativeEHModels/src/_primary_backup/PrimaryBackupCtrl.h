...
#ifndef __PRIMARY_BACKUP_NODECTRL_H_
#define __PRIMARY_BACKUP_NODECTRL_H_
...
#include "../messages/PrimaryBackupUpdate_m.h"
...
class PrimaryBackupCtrl: public HostBase {
...
//    map<string, IPvXAddress> clients;
     ...
     */
    // the applied state from the application layer, with the key corresponding to the index of Qs in NodeApp
    ...
    void receiveUpdate(PrimaryBackupUpdate* update);
